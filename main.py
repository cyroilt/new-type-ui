...
progr=console.progressbar(0,width=9)
colors={1:'#B87333',1.5:'#848789',2:'#c0c0c0',2.5:'#a19d94',3:'#FFD700',3.5:'#e5e4e2'}
texts={1:'copper wire',1.5: 'aluminum wire',2:'silver wire',2.5 : 'iron wire',3:'gold wire',3.5: 'platinum wire'}
